...
function YatrasPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground flex flex-col justify-between">
      ...
      <section data-nav-theme="dark" className="relative min-h-[75vh] flex items-end justify-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10 pb-20 space-y-8">
          ...
          <div className="flex items-center justify-center gap-4 animate-hero-reveal-delay">
            ...
            <span className="text-amber-400/80 text-xs font-semibold uppercase tracking-[0.3em] font-body">Inner Passage & Pilgrimage</span>
          ...
          <h1 className="text-6xl md:text-8xl font-display font-semibold text-white tracking-tight leading-[0.9] animate-hero-reveal">
            Transformational<br />
            <span className="bg-gradient-to-r from-amber-200 via-amber-400 to-orange-400 bg-clip-text text-transparent">Journeys</span>
          </h1>

          <p className="text-white/70 text-sm md:text-lg max-w-2xl mx-auto font-body leading-relaxed animate-hero-reveal-delay">
            Immersive programs designed to awaken your inner consciousness. Move from mere visiting to profound energetic reception under the guidance of scholars.
          </p>
      ...
      <section data-nav-theme="light" className="sticky top-0 z-30 py-5 px-6 border-b border-border" style={{ background: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(20px)' }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6 md:items-center justify-center">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.15em] font-body shrink-0">Filter by Region</span>
      ...
      {/* YATRAS LIST SECTION */}
      <section data-nav-theme="light" className="relative py-20 px-4 sm:px-6 bg-background text-foreground overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10 space-y-8 sm:space-y-12">
          {filteredYatras.length > 0 ? (
            ...
            <div className="p-16 rounded-3xl bg-muted border border-border text-center">
              ...
              <p className="text-muted-foreground font-body text-sm">No transformational journeys found matching your filters.</p>
            </div>
          )}
        </div>

...
export const teerthaDetailsDb: Record<string, TeerthaDetail> = {
  "kashi": {
    ...
    staysDesc: "Experience the mystique of Kashi from a heritage property located right on the ghats. Wake up to the sound of temple bells and the flowing Ganga, with every dawn bringing a new spiritual revelation.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Varanasi Airport / Railway Station — warm traditional welcome",
      ...
      },
      {
        ...
        points: [
          ...
          "Musical Baithak — evening of classical devotional music by artists"
        ]
      },
      {
        day: 5,
  ...
  "rameshwaram": {
    ...
    staysDesc: "Stay in a peaceful oceanfront property with views of the sacred waters. Let the rhythm of the waves and the temple bells guide your spiritual experience.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Madurai Airport — transfer to Rameshwaram (3.5 hrs scenic drive)",
      ...
      },
      {
        ...
        points: [
          ...
          "Visit Gandhamadhana Parvatham — footprint of Lord Rama",
  ...
  "dwarka": {
    ...
    staysDesc: "Stay in a premium property near the Dwarkadhish Temple, letting the temple bells and ocean breeze guide your mornings.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Jamnagar Airport — transfer to Dwarka (2.5 hrs drive)",
      ...
      },
      {
        ...
        points: [
          ...
          "Transfer to Jamnagar Airport — departure with Krishna's blessings"
        ]
      }
    ],
    darshans: [
  ...
  "badrinath": {
    ...
    staysDesc: "Stay in comfortable accommodations in Badrinath and Joshimath with views of the majestic Neelkanth peak and Nanda Devi range. Every morning brings the Himalayas to your doorstep.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Dehradun / Rishikesh — group assembly",
      ...
      },
      {
        ...
        points: [
          ...
          "Begin return journey — overnight at Joshimath/Auli",
  ...
  "jagannath-puri": {
    ...
    staysDesc: "Stay in a comfortable seaside property near the Jagannath Temple, with the sound of ocean waves and temple bells creating the perfect atmosphere for devotion.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Bhubaneswar Airport — transfer to Puri (1.5 hrs drive)",
      ...
      },
      {
        ...
        points: [
          ...
          "Return to Puri — evening free for temple revisit or ocean meditation"
        ]
      },
      {
        day: 4,
  ...
  "haridwar": {
    ...
    staysDesc: "Stay in a serene ashram or riverside property overlooking the Ganga. The sound of flowing water and the fragrance of incense create the perfect setting for spiritual transformation.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Dehradun Airport / Haridwar Station — traditional welcome",
  ...
  "ayodhya": {
    ...
    staysDesc: "Stay in comfortable accommodations near the Ram Mandir, letting the sacred energy of Lord Rama's birthplace permeate your experience. Every morning brings the sound of devotional chanting and temple bells.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Ayodhya Airport / Railway Station — warm welcome",
  ...
  "mathura-vrindavan": {
    ...
    staysDesc: "Stay in a peaceful ashram-style accommodation in Vrindavan, surrounded by ancient temples and the sound of devotional kirtans that fill the air throughout the day.",
    itinerary: [
      {
        day: 1,
        points: [
          "Arrive at Delhi/Agra — transfer to Mathura (2-3 hrs drive)",
      ...
      },
      {
        ...
        points: [
          ...
          "Transfer to Vrindavan — check-in at ashram stay",
  ...
  "shaktipeethas-himachal": {
    ...
    staysDesc: "Stay in a quiet, traditional pine-forested retreat in Kangra and Dharamshala that reflects Himalayan heritage. Wake up to the sound of birdsong and mountain streams.",
    itinerary: [
      {
        day: 1,
        points: [

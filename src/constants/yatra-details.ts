...
export interface YatraDetail {
  ...
  darshans: DarshanCategory[];
  inclusions: string[];
}

export const yatraDetailsDb: Record<string, YatraDetail> = {
  "ayodhya-kashi": {
    slug: "ayodhya-kashi",
    name: "Ayodhya - Kashi",
    date: "20 - 25 Oct",
    duration: "6 Days",
    desc: "Awaken to the ultimate spiritual polarity by experiencing the divine playground of Rama’s Ayodhya and surrender to the timeless, liberating embrace of Shiva’s eternal Kashi.",
    img: ayodhyaKashiImg,
    triplePrice: "Rs. 39000 per Head",
    ...
    inclusions: [
      ...
      "Special Darshan at Vishwanath mandir",
      "Yoga, Pranayam & Dhyan sessions",
      "Swadhyay sessions - Know about the ancient Sanatan scriptures",
      "Mantra sessions - Immerse in the ancient techniques of sound healing and awakening",
  ...
  "rishikesh-badrinath": {
    ...
    date: "26 Sept - 4 Oct",
    duration: "9 Days",
    desc: "Surrender to the vast embrace of the Himalayas, in the ultimate playground of the Divine.",
    img: rishikeshBadrinathImg,
    triplePrice: "Rs. 67,999 per Head",
    ...
    inclusions: [
      ...
      "Clean vegetarian meals tailored for high-altitude health.",
  ...
  himachal: {
    ...
    inclusions: [
      ...
      "Freshly prepared sattvik meals.",

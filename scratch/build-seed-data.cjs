...
yatraContent = yatraContent.replace(/export\s+const\s+yatraDetailsDb[\s\S]*?=\s*/, "module.exports = ");
...
// Convert to module export
teerthaContent = teerthaContent.replace(/export\s+const\s+teerthaDetailsDb[\s\S]*?=\s*/, "module.exports = ");
